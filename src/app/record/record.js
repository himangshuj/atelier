(function (ng, app) {
    ng.module(app, [
        ...
        .controller('RecordMaster', ["$scope", "answer", "acoustics", "dialogue", "anduril", "recordAction", "recorder",
            function ($scope, answer, acoustics, dialogue, anduril, recordAction, recorder) {
