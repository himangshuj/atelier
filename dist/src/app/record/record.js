(function (ng, app) {
  ng.module(app, [
    ...
    var presentations = _.map(anduril.fetchVariablesForPresentationId($stateParams.presentationId), function (obj) {
    ...
    $scope.play = function () {
      $q.when(anduril.completeRecord(scriptId)).then(function (resp) {
        $state.go('play', {
          presentationId: $stateParams.presentationId,
